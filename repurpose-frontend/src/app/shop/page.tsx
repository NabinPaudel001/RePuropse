...
const ShopPage: React.FC = () => {
  const sampleProducts = [
    ...
    { id: 10, name: "Product 9", price: 250, category: "Fashion", imageUrl: "/assets/bg.png" },
    { id: 11, name: "Product 10", price: 50, category: "Electronics", imageUrl: "/assets/bg.png" },
    { id: 12, name: "Product 12", price: 150, category: "Fashion", imageUrl: "/assets/bg.png" },
    { id: 13, name: "Product 13", price: 300, category: "Home", imageUrl: "/assets/bg.png" },
    { id: 14, name: "Product 14", price: 20, category: "Toys", imageUrl: "/assets/bg.png" },
    { id: 15, name: "Product 15", price: 400, category: "Men", imageUrl: "/assets/bg.png" },
    { id: 16, name: "Product 16", price: 90, category: "Women", imageUrl: "/assets/bg.png" },
    { id: 17, name: "Product 17", price: 200, category: "Toys", imageUrl: "/assets/bg.png" },
    { id: 18, name: "Product 18", price: 250, category: "Fashion", imageUrl: "/assets/bg.png" },
