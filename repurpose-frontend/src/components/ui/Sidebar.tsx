...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] h-screen p-4 fixed shadow-lg flex flex-col justify-between">
      <div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li>
              <Link href="/seller/dashboard/messages" className="flex items-center text-lg font-semibold hover:text-[hsl(var(--primary-foreground))] transition-colors duration-200">
      ...
      {/* <div>
        <h3 className="text-[hsl(var(--secondary-foreground))] text-xs uppercase mt-6 mb-4 tracking-wider">Others</h3>
        <ul className="space-y-4">
          <li>
            <Link href="/seller/dashboard/analytics" className="flex items-center text-lg font-semibold hover:text-[hsl(var(--primary-foreground))] transition-colors duration-200">
              <MdBarChart className="mr-3" /> Product Analytics
            </Link>
          </li>
        </ul>
      </div> */}
